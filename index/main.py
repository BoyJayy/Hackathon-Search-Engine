...
# MVP chunking follows message boundaries instead of raw character windows.
CHUNK_SIZE = max(int(os.getenv("CHUNK_SIZE", "10")), 1)
OVERLAP_SIZE = max(int(os.getenv("OVERLAP_SIZE", "2")), 0)
LONG_MESSAGE_THRESHOLD = max(int(os.getenv("LONG_MESSAGE_THRESHOLD", "2000")), 1)
    ...
    return IndexAPIResponse(
        results=[
            IndexAPIItem(
                ...
                dense_content=chunk.dense_content,
                sparse_content=chunk.sparse_content,
